...
exports.editMovie = asyncHandler(async (req, res, next) => {
  console.log(`[TABLET2] recieved Set/delete cells request from Client`);
...
exports.deleteMovie = asyncHandler(async (req, res, next) => {
  console.log("[TABLET2] Client request delete films");
...
exports.addMovie = asyncHandler(async (req, res, next) => {
  console.log("[TABLET2] recieved Add request");
  createMovie(req, res, next);
});

//5) ->read row(s)
exports.getMovies = asyncHandler(async (req, res, next) => {
  console.log("[TABLET2] Client reqest films");
